...
# === Added for birthdate-based period ===
nate_birthdate = 5
partner_birthdate = 4

# Choose the quotient closest to 1
quotient1 = nate_birthdate / partner_birthdate
quotient2 = partner_birthdate / nate_birthdate
period = quotient1 if abs(quotient1 - 1) < abs(quotient2 - 1) else quotient2
# ========================================
...
# === Modified omega using computed period ===
omega = 2 * pi / period
# =============================================
